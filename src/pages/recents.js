    ...
    return (
        <Box>
            <Box display="flex" justifyContent="space-between" alignItems="center">
                <Box p="20px">
                    <Typography variant='h5'>Recently viewed Podcast</Typography>
                    <Typography variant='subtitle1'>You have <span>1</span> Podcast in this list</Typography>
                </Box>
                <Box>
                    <IconButton
                        aria-label="more"
            ...
            {/* Recently streamed podcast */}
            <Box display="flex" justifyContent="space-between" alignItems="center" mt="40px">
                <Box p="20px">
                    <Typography variant='h5'> Recently streamed podcat</Typography>
                    <Typography variant='subtitle1'>You have <span>1</span> Podcast in this list</Typography>
                </Box>
                <Box>
                    <IconButton
